...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.section.reasoningTraces": "Trazas de razonamiento",
  "settings.openchamber.visual.section.reasoningTracesAria": "Modo de visualización de trazas de razonamiento",
  "settings.openchamber.visual.option.reasoningMode.off.label": "Oculto",
  "settings.openchamber.visual.option.reasoningMode.off.description": "Oculta todos los bloques de razonamiento.",
  "settings.openchamber.visual.option.reasoningMode.off.aria": "Trazas de razonamiento: oculto",
  "settings.openchamber.visual.option.reasoningMode.collapsibleHidden.label": "Plegado",
  "settings.openchamber.visual.option.reasoningMode.collapsibleHidden.description": "El razonamiento se colapsa por defecto y permanece colapsado durante el streaming. Haz clic para expandir.",
  "settings.openchamber.visual.option.reasoningMode.collapsibleHidden.aria": "Trazas de razonamiento: plegado",
  "settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.label": "Dinámico",
  "settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.description": "El razonamiento se expande automáticamente durante el streaming y se colapsa al terminar. Haz clic para anular.",
  "settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.aria": "Trazas de razonamiento: dinámico",
  "settings.openchamber.visual.option.reasoningMode.full.label": "Visible",
  "settings.openchamber.visual.option.reasoningMode.full.description": "Muestra el razonamiento como texto en línea sin opción de colapsar.",
  "settings.openchamber.visual.option.reasoningMode.full.aria": "Trazas de razonamiento: visible",
