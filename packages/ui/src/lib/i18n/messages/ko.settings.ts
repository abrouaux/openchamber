...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.section.reasoningTraces': 'Reasoning Trace',
  'settings.openchamber.visual.section.reasoningTracesAria': 'Reasoning trace 표시 모드',
  'settings.openchamber.visual.option.reasoningMode.off.label': '숨김',
  'settings.openchamber.visual.option.reasoningMode.off.description': '모든 추론/사고 블록을 숨깁니다.',
  'settings.openchamber.visual.option.reasoningMode.off.aria': 'Reasoning trace: 숨김',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.label': '접힘',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.description': '추론은 기본적으로 접혀 있으며 스트리밍 중에도 접혀 있습니다. 클릭하여 펼칩니다.',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.aria': 'Reasoning trace: 접힘',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.label': '동적',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.description': '추론은 스트리밍 중 자동으로 펼쳐지고 종료 시 접힙니다. 클릭하여 재정의합니다.',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.aria': 'Reasoning trace: 동적',
  'settings.openchamber.visual.option.reasoningMode.full.label': '표시',
  'settings.openchamber.visual.option.reasoningMode.full.description': '추론을 일반 인라인 텍스트로 표시하며 접을 수 없습니다.',
  'settings.openchamber.visual.option.reasoningMode.full.aria': 'Reasoning trace: 표시',
