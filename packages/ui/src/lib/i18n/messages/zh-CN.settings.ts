...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.section.reasoningTraces': '推理轨迹',
  'settings.openchamber.visual.section.reasoningTracesAria': '推理轨迹显示模式',
  'settings.openchamber.visual.option.reasoningMode.off.label': '隐藏',
  'settings.openchamber.visual.option.reasoningMode.off.description': '隐藏所有推理/思考块。',
  'settings.openchamber.visual.option.reasoningMode.off.aria': '推理轨迹：隐藏',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.label': '折叠',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.description': '推理默认折叠，流式传输时保持折叠。点击展开。',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.aria': '推理轨迹：折叠',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.label': '动态',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.description': '推理在流式传输时自动展开，结束时折叠。点击覆盖。',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.aria': '推理轨迹：动态',
  'settings.openchamber.visual.option.reasoningMode.full.label': '可见',
  'settings.openchamber.visual.option.reasoningMode.full.description': '将推理显示为普通内联文本，不可折叠。',
  'settings.openchamber.visual.option.reasoningMode.full.aria': '推理轨迹：可见',
