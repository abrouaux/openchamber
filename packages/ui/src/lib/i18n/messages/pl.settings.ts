export const settingsDict = {
  ...
  'settings.openchamber.visual.goal.description': 'Uzbrój przycisk celu w kompozytorze, a następna wiadomość stanie się celem: agent będzie nad nim automatycznie pracował, audytowany przez mały model, nawet pod twoją nieobecność.',
  ...
  'settings.openchamber.visual.section.reasoningTraces': 'Ślady rozumowania',
  'settings.openchamber.visual.section.reasoningTracesAria': 'Tryb wyświetlania śladów rozumowania',
  'settings.openchamber.visual.option.reasoningMode.off.label': 'Ukryte',
  'settings.openchamber.visual.option.reasoningMode.off.description': 'Ukryj wszystkie bloki rozumowania/myślenia.',
  'settings.openchamber.visual.option.reasoningMode.off.aria': 'Ślady rozumowania: ukryte',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.label': 'Zwinięte',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.description': 'Rozumowanie domyślnie jest zwinięte i pozostaje zwinięte podczas przesyłania. Kliknij, aby rozwinąć.',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.aria': 'Ślady rozumowania: zwinięte',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.label': 'Dynamiczne',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.description': 'Rozumowanie automatycznie rozwija się podczas przesyłania i zwija po zakończeniu. Kliknij, aby nadpisać.',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.aria': 'Ślady rozumowania: dynamiczne',
  'settings.openchamber.visual.option.reasoningMode.full.label': 'Widoczne',
  'settings.openchamber.visual.option.reasoningMode.full.description': 'Pokazuj rozumowanie jako zwykły tekst w linii, bez zwijania.',
  'settings.openchamber.visual.option.reasoningMode.full.aria': 'Ślady rozumowania: widoczne',
